...
out, err = run_bash(["cat", "general/tab-tab-attack/Addadshashanammu/Addadshashanammu/Almurbalarammi/Ashalmimilkala/Assurnabitashpi/Maelkashishi/Onnissiralis/Ularradallaku/fang-of-haynekhtnamet", "|", "grep", "-a", "picoCTF"])
